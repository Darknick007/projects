...
var numtargets = 7; // numeri di quanti target ci sono
...
function SetTexts(){
    precision = click-counter;
    numTargetMoved=numTargetMoved+precision;
    precision = (counter/click)*100;
    score.textContent= "Score= "+counter+"/"+numTargetMoved + " Precision:"+ precision + "%";
